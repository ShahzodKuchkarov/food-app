  ...
  return (
    <Sign>
      ...
      <form onSubmit={handelSubmit}>
        ...
        <input placeholder="First name" onChange={handleInputChange} type="text" name="firstName" />
        <input placeholder="Last name" onChange={handleInputChange} type="text" name="lastName" />
